...
//settings
global.owner = ['254768371432',''] //owner number +27634090203
global.wame = ['254768371432'] 
global.pemilik = ['254768371432'] //owner number +27634090203
global.premium = ['254768371432'] //premium number +27634090203
global.pengguna = 'prince' //username
global.footer = 'prince'
global.botnma = 'prince bot' //bot name
global.botname = 'prince BOT V4'
global.ownernma = 'prince' //owner name
global.packname = 'prince' //sticker package name
global.author = 'By prince Memes' //sticker author name
...
global.mess = {
    ...
    admin: '*This feature is only for admin baka!*',
    botAdmin: '*prince bot  must be admin first🥲!*',
    owner: '*this feature is only for my owner 🥲*',
    group: '*Feature is only for groups🥲!*',
    grouponly: '*Group Mode Only🥲*',
    private: 'Features Used Only For Private Chat!',
    bot: 'This feature in only for the bot number',
    wait: '*whoa wait a moment prince bot proccessing*',
